...
#+BEGIN_SRC emacs-lisp
  (use-package writeroom-mode
    ...
    (advice-add 'writeroom--enable :before #'smf/do-not-disturb)
    (advice-add 'writeroom--disable :before (lambda () (smf/do-not-disturb t))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun smf/do-not-disturb (&optional disable)
    "Toggles the Do Not Disturb button in MacOS Notification Center.
