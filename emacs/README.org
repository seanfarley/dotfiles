...
After trying =jdee= and =malabar=, =eclim= was the only package that actually
worked.
...
Also, install =flycheck-tip= which has =eclim= support.

#+begin_src emacs-lisp
  (require-package 'flycheck-tip)
  (require 'flycheck-tip)
  (require 'eclim-tip)
  (after-load 'eclim-tip
    (global-set-key (kbd "M-n") 'eclim-tip-cycle)
...
#+begin_src emacs-lisp
  ...
  (if (file-accessible-directory-p "~/projects/erc-hipchatify")
      (smf/add-to-load-path "~/projects/erc-hipchatify"))
...
Also, please rescale images to the 0.4 size of the window,
  ...
  (after-load 'mu4e
    (defun smf/mu4e-action-hg-import-patch (msg)
      ...
      (let ((path (read-directory-name "Target directory: " "~/projects/hg" nil nil nil) ))
        (shell-command
         (format "cd %s; hg import --obsolete --partial %s"
                 path
