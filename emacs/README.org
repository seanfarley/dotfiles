...
Automatically adds the closing parenthesis, pretty self-explanatory:
...
#+begin_src emacs-lisp
  (prodigy-define-tag
    ...
    :env `(("BB_EMAIL_PASSWORD"
           ...
           ("HGRCPATH" ,(expand-file-name "~/projects/bitbucket/hgrc"))
...
#+begin_src emacs-lisp
  (prodigy-define-service
    ...
    :env `(("HGRCPATH" ,(expand-file-name "~/projects/bitbucket/hgrc")))
    :tags '(bitbucket)
