...
#+BEGIN_SRC emacs-lisp
  (use-package mu4e
    ...
    ;; fix bug with not running hooks when opening an unread message
    ;; https://github.com/djcb/mu/pull/1265
    (defun smf/mu4e~view-internal (msg)
    ...
    (advice-add 'mu4e~view-internal :override 'smf/mu4e~view-internal))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq-default org-startup-folded nil
                  ...
                  '(("t" "Tasks" entry
                     (file+headline (lambda () smf/org-input) "Inbox")
                     "* TODO %?\n  Captured %<%Y-%m-%d %H:%M>\n  %a\n\n  %i"))
...
#+BEGIN_SRC emacs-lisp
  (use-package ivy-rich
    ...
    ;; with “~”)
    (setq-default ivy-rich-abbreviate-paths t)
...
#+BEGIN_SRC emacs-lisp
  (use-package eshell
    ...
    (setq-default esh-sep " ")                    ; or " | "

    ;; Separator between an esh-section icon and form
    (setq-default esh-section-delim " ")

    ;; Eshell prompt header
    (setq-default esh-header "\n┌─ ")             ; or "\n┌─"

    ;; Eshell prompt regexp and string. Unless you are varying the prompt by eg.
    ;; your login, these can be the same.
    (setq-default eshell-prompt-regexp "└→ ")     ; or "└─> "
    (setq-default eshell-prompt-string "└→ ")     ; or "└─> "

    ;; Choose which eshell-funcs to enable
    (setq-default eshell-funcs (list esh-dir esh-hg esh-git esh-python))
