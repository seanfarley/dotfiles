...
#+begin_src emacs-lisp
  (prodigy-define-tag
    ...
    :env `(("BB_EMAIL_PASSWORD"
           ...
           ("LANG" "en_US.UTF-8")
           ("PATH" ,(concat (expand-file-name "~/.virtualenvs/bb/bin") ":" (getenv "PATH")))
           ("VIRTUAL_ENV" ,(expand-file-name "~/.virtualenvs/bb/"))))
#+end_src
...
#+begin_src emacs-lisp
  (prodigy-define-service
    ...
    :path (expand-file-name "~/.env/bb/bin")
    :tags '(bitbucket python)
