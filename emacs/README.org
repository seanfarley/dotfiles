...
#+BEGIN_SRC emacs-lisp
  (use-package notmuch
    ...
    ;; variable to hold patch directory history
    (defvar smf/recent-patch-dirs '("~/projects/hg")
      "List of recent directories used to apply patches.")
      ...
      (ivy-read "Target directory: "
                ...
                :action (lambda (d)
                          (notmuch-show-pipe-message
                           nil (format "hg --cwd %s import --obsolete -" d)))))
...
#+BEGIN_SRC emacs-lisp
  (use-package indium
    :ensure t
    :commands indium-connect-to-chrome
    :config
